...
/* USER CODE BEGIN PV */
uint8_t sensor_1_value;
uint8_t sensor_2_value;
uint8_t sensor_3_value;
...
int main(void)
{
  ...
  while (1)
  {
	 ...
	 //---SENSOR TEST---
	  /*
	  sensor_1_value = HAL_GPIO_ReadPin(SENSOR_1_GPIO_Port, SENSOR_1_Pin);
	  sensor_2_value = HAL_GPIO_ReadPin(SENSOR_2_GPIO_Port, SENSOR_2_Pin);
	  sensor_3_value = HAL_GPIO_ReadPin(SENSOR_3_GPIO_Port, SENSOR_3_Pin);
	  ...
	  button_1_value = HAL_GPIO_ReadPin(BUTTON_2_GPIO_Port,BUTTON_2_Pin);
	  */
